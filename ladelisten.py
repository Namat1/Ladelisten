...
st.set_page_config(page_title="Tour-/Ladeplan", page_icon="🚚", layout="wide")# -*- coding: utf-8 -*-
"""
Tour-/Ladeplan-Generator (NFC / EDEKA Nord)
Logik:
- Blatt 'LADEREIHENFOLGE' (Tour, LF, SAP, Name, Strasse, PLZ, Ort) -> LF1 oben
...
with c1:
    aus = st.selectbox("Tag (= 1. Ziffer der Tour)", list(opt.keys()))
z = opt[aus]
with c2:
    datum = st.date_input("Druckdatum", value=date.today(), format="DD.MM.YYYY")
